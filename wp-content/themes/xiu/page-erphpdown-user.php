...
<section class="container">
	<div class="pagewrapper clearfix" id="profile" >
		...
		<aside class="pagesidebar" style="top:48px;">
			...
			<?php }elseif($_GET["pd"]=='money'){ 
                ...
                <h2 class="profile-title">升级VIP</h2>
                	<table class="form-table">
                        ...
                        <tr>
                            <td>
                                <?php if($ciphp_life_price){?><input type="radio" id="userType10" name="userType" value="10" checked /><?php echo $erphp_life_name;?>（<?php echo $ciphp_life_price.get_option('ice_name_alipay')?> ）&nbsp;<?php }?>
                                <?php if($ciphp_year_price){?><input type="radio" id="userType9" name="userType" value="9" checked/><?php echo $erphp_year_name;?>（<?php echo $ciphp_year_price.get_option('ice_name_alipay')?> ）&nbsp;<?php }?>
                                <?php if($ciphp_quarter_price){?><input type="radio" id="userType8" name="userType" value="8" checked/><?php echo $erphp_quarter_name;?>（<?php echo $ciphp_quarter_price.get_option('ice_name_alipay')?> ）&nbsp;<?php }?>
                                <?php if($ciphp_month_price){?><input type="radio" id="userType7" name="userType" value="7" checked/><?php echo $erphp_month_name;?>（<?php echo $ciphp_month_price.get_option('ice_name_alipay')?> ）&nbsp;<?php }?>
                                <?php if($ciphp_day_price){?><input type="radio" id="userType6" name="userType" value="6" checked/><?php echo $erphp_day_name;?>（<?php echo $ciphp_day_price.get_option('ice_name_alipay')?> ）<?php }?>
                            </td>
                        </tr>
                        <tr>
